...
| :------: | :-------: | ----------------------- | ---------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| Prework  |           | your own pace           | check the Prework and Software Requirements instructions   |                            | [Colab](https://colab.research.google.com/drive/13rQM_WVZJNfj-uRdRHsCX0MhUdH2FE-w) or [notebook](https://katrienantonio.github.io/IABE-DS-module-1/notebooks/read_data_module_1.ipynb) |                            |
...
| Module 1 | Session 1 | 9.30 - 9.40             | Statistical and machine learning                           |                            |                                                                                                                                                                                        |                            |
|          |           | 9.40 - 9.50             | Model accuracy and loss functions                          |                            |                                                                                                                                                                                        |                            |
|          |           | 9.50 - 10.00            | Overfitting and bias-variance trade off                    |                            |                                                                                                                                                                                        |                            |
|          |           | 10.00 - 10.30           | Data splitting and resampling methods                      |                            |                                                                                                                                                                                        |                            |
|          |           | 10.40 - 10.50           | (cont.)                                                    |                            |                                                                                                                                                                                        |                            |
|          |           | 10.50 - 11.30           | Parameter tuning                                           |                            |                                                                                                                                                                                        |                            |
|          |           | 11.40 - 12.30           | Target and feature engineering                             |                            |                                                                                                                                                                                        |                            |
...
Download lecture sheets in [pdf]() (follows asap).
...
basic instructions: [simple notebook]().
