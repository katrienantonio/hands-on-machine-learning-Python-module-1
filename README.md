...
## Workshop Hands-on Machine Learning in Python, March 2023 edition
...
detailed schedule is subject to small changes. (Links to lecture
material follow asap.)

|  Module  |  Session  | Duration                | Description                                                | Lecture material                                                                                                                | Link to Colab                                                                                  | Link to notebook or script                                                                                                                             |
| :------: | :-------: | ----------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Prework  |           | your own pace           | check the Prework and Software Requirements instructions   |                                                                                                                                 | [Colab](https://colab.research.google.com/drive/13rQM_WVZJNfj-uRdRHsCX0MhUdH2FE-w)             | [notebook](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/notebooks/read_data_module_1.ipynb)                              |
| Prework  |           | day before the workshop | check the course material on the GitHub repo and get ready | check Zoom link sent by AI                                                                                                      | if possible, work with two screens: one for the Zoom session and one for coding                |                                                                                                                                                        |
| Module 1 | Session 1 | 9.30 - 9.40             | Statistical and machine learning                           | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#knowing)        | [Colab](https://colab.research.google.com/drive/1BDkCMYoDHZEWnjuqv19zCBq-ZfmPbvKJ?usp=sharing) | [notebook](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/notebooks/Hands_on_ML_with_Python_with_YourTurns_Module_1.ipynb) |
|          |           | 9.40 - 9.50             | Model accuracy and loss functions                          | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#accuracy)       |                                                                                                |                                                                                                                                                        |
|          |           | 9.50 - 10.00            | Overfitting and bias-variance trade off                    | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#overfit)        |                                                                                                |                                                                                                                                                        |
|          |           | 10.00 - 10.30           | Data splitting and resampling methods                      | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#resampling)     |                                                                                                |                                                                                                                                                        |
|          |           | 10.40 - 10.50           | (cont.)                                                    |                                                                                                                                 |                                                                                                |                                                                                                                                                        |
|          |           | 10.50 - 11.30           | Parameter tuning                                           | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#tuning)         |                                                                                                |                                                                                                                                                        |
|          |           | 11.40 - 12.30           | Target and feature engineering                             | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#engineering)    |                                                                                                |                                                                                                                                                        |
| Module 1 | Session 2 | 09.30 - 10.10           | Target and feature engineering                             | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#engineering)    | [Colab](https://colab.research.google.com/drive/1BDkCMYoDHZEWnjuqv19zCBq-ZfmPbvKJ?usp=sharing) | [notebook](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/notebooks/Hands_on_ML_with_Python_with_YourTurns_Module_1.ipynb) |
|          |           | 10.10 - 10.30           | Linear regression                                          | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#regression)     |                                                                                                |                                                                                                                                                        |
|          |           | 10.40 - 11.10           | GLMs                                                       | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#GLMs)           |                                                                                                |                                                                                                                                                        |
|          |           | 11.10 - 11.20           | GAMs                                                       | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#GAMs)           |                                                                                                |                                                                                                                                                        |
|          |           | 11.30 - 11.40           | GAMs                                                       |                                                                                                                                 |                                                                                                |                                                                                                                                                        |
|          |           | 11.40 - 12.30           | Regularized (G)LMs                                         | [sheets](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_part1_Python.html#regularization) |                                                                                                |                                                                                                                                                        |
...
In two sessions we cover:
  ...
  - importing data and basic data explorations with `pandas`, `seaborn`
    (among others)
  - machine learning foundations, including resampling and tuning of
    parameters with `scikit-learn`
  - feature pre-processing steps, including setting up a pipeline with
    `scikit-learn`
  - regression models, including regularization, with `scikit-learn`,
    `statsmodels` and the `statsmodels.api`

Download lecture sheets in
[pdf](https://katrienantonio.github.io/hands-on-machine-learning-Python-module-1/sheets/ML_Python_module_1.pdf).
